...
rpcWallet.createWalletClient = function (config) {
  ...
  return {
    ...
    */
    ...
    /**
    * Create a new wallet. You need to have set the argument "–wallet-dir" when launching scala-wallet-rpc to make this work.
    * @async
    * @param {Object} opts
    ...
    *  [
    *   {
    *    address: 'SvkT5HP3c46BhPYdj4jzqxGBTKkixTbQ5bGXFVQkta2Z9hs8xUEjx68J8PQFRRs87uefHo5huNW9Bi7YrttZZU5M36hEkc1f1',
    *    amount: 1100000000,
    *    block_height: 8667,
    ...
    */
    ...
    /**
    * Open a wallet. You need to have set the argument "–wallet-dir" when launching scala-wallet-rpc to make this work.
    * @async
    * @param {Object} opts
    ...
    *  standard_address: 'SvkT5HP3c46BhPYdj4jzqxGBTKkixTbQ5bGXFVQkta2Z9hs8xUEjx68J8PQFRRs87uefHo5huNW9Bi7YrttZZU5M36hEkc1f1'
    * }
    */
    ...
    /**
    * Start mining in the Scala daemon.
    * @async
    * @param {Object} opts
    ...
    * @param {number} opts.unlock_time - Number of blocks before the XLA can be spent (0 to not add a lock).
    ...
    * @param {Object} opts
    * @param {boolean} [opts.get_tx_keys] - Return the transaction keys after sending.
    * @param {boolean} [opts.do_not_relay] - If true, the newly created transaction will not be relayed to the Scala network. (Defaults to false).
    ...
    */
    ...
    /**
    * Send XLA to a number of recipients.
    * @async
    * @param {Object} opts
    * @param {string[]} opts.destinations - Array of destinations to receive XLA.
    ...
    */
    ...
    /**
    * Parse an address to validate if it's a valid Scala address.
    * @async
    * @param {Object} opts
